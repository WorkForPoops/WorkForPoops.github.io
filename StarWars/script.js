...
function game(){
	...
	let num = 10;
	let counter = () => {
		document.querySelector('.score').innerHTML = `Счет: ${score}`;
	}
	let score = 0;
	counter();
	...
	function createBullet() {
		...
		bullet.style.top = player.offsetTop + 95 + "px";
	...
	function createEnemy() {
		...
		let timerId = setInterval(function() {
			...
			enemy.style.left = (enemy.offsetLeft - num) + "px";
